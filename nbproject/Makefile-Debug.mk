...
${OBJECTDIR}/_ext/683866282/SpaceShip.o: ../SpaceRace/Entity/SpaceShip.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/683866282
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -I../../SFML/include -IContentManager -IGameState -IEntity -I. -ICollider -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/683866282/SpaceShip.o ../SpaceRace/Entity/SpaceShip.cpp

${OBJECTDIR}/_ext/533720680/GameOverState.o: ../SpaceRace/GameState/GameOverState.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/533720680
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -I../../SFML/include -IContentManager -IGameState -IEntity -I. -ICollider -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/533720680/GameOverState.o ../SpaceRace/GameState/GameOverState.cpp
