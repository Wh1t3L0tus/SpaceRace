...
${OBJECTDIR}/src/Spawner/BasicSpawner.o: src/Spawner/BasicSpawner.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../lib/SFML-2.1/include -Isrc/Background -Isrc/Collider -Isrc/ContentManager -Isrc/Entity -Isrc/GameState -Isrc/Gui -Isrc/Spawner -Isrc -Isrc/WavesLoader -I../lib/jsoncpp-src-0.5.0/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Spawner/BasicSpawner.o src/Spawner/BasicSpawner.cpp
